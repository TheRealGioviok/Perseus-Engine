...
void uciStr() {
    ...
    std::cout << "option name hhthresh type spin default 3739 min 0 max 16383" << std::endl;
    std::cout << "option name lmrDepthValue type spin default 993 min 0 max 16383" << std::endl;
    std::cout << "option name lmrMoveValue type spin default 784 min 0 max 16383" << std::endl;
    std::cout << "option name lmrA type spin default 745 min 0 max 16383" << std::endl;
    std::cout << "option name lmrC type spin default 492 min -1000 max 1000" << std::endl;
    std::cout << "option name BADCAPTURESCORE type spin default 16389 min 0 max 32768" << std::endl;
    std::cout << "option name futilityMarginDelta type spin default 82 min 55 max 125" << std::endl;
    std::cout << "option name nmpBias type spin default 18 min 0 max 30" << std::endl;
    std::cout << "option name nmpDepthDivisor type spin default 3 min 2 max 6" << std::endl;
    std::cout << "option name nmpScoreDivisor type spin default 203 min 100 max 300" << std::endl;
    std::cout << "option name nmpQ1 type spin default 3 min 1 max 4" << std::endl;
    std::cout << "option name nmpQ2 type spin default 4 min 0 max 4" << std::endl;
    std::cout << "option name razorQ1 type spin default 124 min 50 max 200" << std::endl;
    std::cout << "option name razorQ2 type spin default 175 min 100 max 300" << std::endl;
