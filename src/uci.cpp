...
void uciStr() {
    ...
    std::cout << "option name lmrA0 type spin default 763 min -5000 max 5000" << std::endl;
    std::cout << "option name lmrC0 type spin default -275 min -5000 max 5000" << std::endl;
    std::cout << "option name lmrA1 type spin default 775 min -5000 max 5000" << std::endl;
    std::cout << "option name lmrC1 type spin default 625 min -5000 max 5000" << std::endl;
    std::cout << "option name lmpA0 type spin default 500 min -5000 max 5000" << std::endl;
    std::cout << "option name lmpC0 type spin default 1500 min -5000 max 5000" << std::endl;
    std::cout << "option name lmpA1 type spin default 1000 min -5000 max 5000" << std::endl;
    std::cout << "option name lmpC1 type spin default 3000 min -5000 max 5000" << std::endl;
    std::cout << "option name futilityMarginDelta type spin default 91 min 0 max 999" << std::endl;
