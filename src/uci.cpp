...
void uciStr() {
    ...
    std::cout << "option name lmrMoveValue type spin default 990 min 0 max 16383" << std::endl;
    std::cout << "option name lmrA0 type spin default 650 min 0 max 16383" << std::endl;
    std::cout << "option name lmrC0 type spin default -275 min -1000 max 1000" << std::endl;
    std::cout << "option name lmrA1 type spin default 650 min 0 max 16383" << std::endl;
    std::cout << "option name lmrC1 type spin default 600 min -1000 max 1000" << std::endl;
    std::cout << "option name lmpA0 type spin default 500 min 0 max 16383" << std::endl;
    std::cout << "option name lmpC0 type spin default 1500 min -1000 max 1000" << std::endl;
    std::cout << "option name lmpA1 type spin default 1000 min 0 max 16383" << std::endl;
    std::cout << "option name lmpC1 type spin default 3000 min -1000 max 1000" << std::endl;
    std::cout << "option name futilityMarginDelta type spin default 105 min 55 max 125" << std::endl;
    ...
    std::cout << "option name razorQ1 type spin default 156 min 50 max 400" << std::endl;
    std::cout << "option name razorQ2 type spin default 224 min 50 max 400" << std::endl;
