...
void uciStr() {
    ...
    std::cout << "option name lmrDepthValue type spin default 910 min 0 max 16383" << std::endl;
    std::cout << "option name lmrMoveValue type spin default 843 min 0 max 16383" << std::endl;
    std::cout << "option name lmrA type spin default 808 min 0 max 16383" << std::endl;
    std::cout << "option name lmrC type spin default 595 min -1000 max 1000" << std::endl;
    std::cout << "option name BADCAPTURESCORE type spin default 16069 min 0 max 32768" << std::endl;
    std::cout << "option name futilityMarginDelta type spin default 79 min 55 max 125" << std::endl;
    std::cout << "option name nmpBias type spin default 11 min 0 max 30" << std::endl;
    std::cout << "option name nmpDepthDivisor type spin default 3 min 2 max 6" << std::endl;
    std::cout << "option name nmpScoreDivisor type spin default 248 min 100 max 300" << std::endl;
    ...
    std::cout << "option name razorQ1 type spin default 225 min 50 max 400" << std::endl;
    std::cout << "option name razorQ2 type spin default 197 min 50 max 400" << std::endl;
    ...
    std::cout << "option name futPruningMultiplier type spin default 167 min 50 max 300" << std::endl;
    std::cout << "option name futPruningAdd type spin default 244 min 50 max 300" << std::endl;
