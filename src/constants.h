...
TUNE_PARAM(historyBonusQuadDepth, 8, 1, 1536, 77, 0.002);
TUNE_PARAM(historyBonusLinDepth, 204, 1, 1536, 77, 0.002);
TUNE_PARAM(historyBonusOffset, -147, -1024, 1024, 102, 0.002);

TUNE_PARAM(maxHistoryMalus, 1039, 1, 4096, 205, 0.002);
TUNE_PARAM(historyMalusQuadDepth, 5, 1, 1536, 77, 0.002);
...
// PVS SEE
TUNE_PARAM(pvsSeeThresholdQuiet, -32, -160, -10, 8, 0.002)
TUNE_PARAM(pvsSeeThresholdNoisy, -112, -160, -10, 8, 0.002)
...
TUNE_PARAM(historyPruningQuietMultiplier, -2314, -5120, -1024, 205, 0.002);
TUNE_PARAM(historyPruningQuietBias, -1157, -2048, 2048, 205, 0.002);

TUNE_PARAM(historyPruningNoisyMultiplier, -1000, -5120, -1024, 205, 0.002);
TUNE_PARAM(historyPruningNoisyBias, -1000, -2048, 2048, 205, 0.002);
