...
TUNE_PARAM(lmrQuietHistoryDivisor, 8497, 2000, 14000, 600, 0.002)
...
TUNE_PARAM(lmrNoisyHistoryDivisorA, 5326, 2000, 14000, 600, 0.002)
TUNE_PARAM(lmrNoisyHistoryDivisorB, 6861, 2000, 14000, 600, 0.002)
...
// LMP values
TUNE_PARAM(lmpA0, 523, 250, 1750, 75, 0.002);
TUNE_PARAM(lmpC0, 1620, 500, 5000, 225, 0.002);
TUNE_PARAM(lmpA1, 997, 250, 1750, 75, 0.002);
...
TUNE_PARAM(nonPawnCorrWeight, 1069, 0, 2048, 204, 0.002)
TUNE_PARAM(T0CorrWeight, 1048, 0, 2048, 204, 0.002)
TUNE_PARAM(T1CorrWeight, 1005, 0, 2048, 204, 0.002)
TUNE_PARAM(T2CorrWeight, 1025, 0, 2048, 204, 0.002)
TUNE_PARAM(T3CorrWeight, 1021, 0, 2048, 204, 0.002)
TUNE_PARAM(T4CorrWeight, 1058, 0, 2048, 204, 0.002)
TUNE_PARAM(T5CorrWeight, 975, 0, 2048, 204, 0.002)
TUNE_PARAM(T6CorrWeight, 1105, 0, 2048, 204, 0.002)
TUNE_PARAM(T7CorrWeight, 1106, 0, 2048, 204, 0.002)
TUNE_PARAM(T8CorrWeight, 962, 0, 2048, 204, 0.002)
...
TUNE_PARAM(T2CorrUpdate, 1003, 0, 2048, 204, 0.002)
TUNE_PARAM(T3CorrUpdate, 1032, 0, 2048, 204, 0.002)
TUNE_PARAM(T4CorrUpdate, 950, 0, 2048, 204, 0.002)
TUNE_PARAM(T5CorrUpdate, 976, 0, 2048, 204, 0.002)
TUNE_PARAM(T6CorrUpdate, 976, 0, 2048, 204, 0.002)
TUNE_PARAM(T7CorrUpdate, 1038, 0, 2048, 204, 0.002)
TUNE_PARAM(T8CorrUpdate, 1108, 0, 2048, 204, 0.002)
TUNE_PARAM(T9CorrUpdate, 968, 0, 2048, 204, 0.002)
