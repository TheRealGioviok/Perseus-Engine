...
TUNE_PARAM(quietHistoryPruningDepth, 5, 2, 8, 0.5, 0.002);
TUNE_PARAM(quietHistoryPruningMultiplier, -1512, -5120, -1024, 205, 0.002);
TUNE_PARAM(quietHistoryPruningBias, -512, -2048, 2048, 205, 0.002);
TUNE_PARAM(captHistoryPruningDepth, 4, 2, 8, 0.5, 0.002);
TUNE_PARAM(captHistoryPruningMultiplier, -1280, -5120, -1024, 205, 0.002);
TUNE_PARAM(captHistoryPruningBias, -128, -2048, 2048, 205, 0.002);
