...
TUNE_PARAM(MAXCORRHISTMILLIUPDATE, 256, 16, 512, 25, 0.002)

// CorrHist correction values
TUNE_PARAM(pawnCorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(nonPawnCorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T0CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T1CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T2CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T3CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T4CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T5CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T6CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T7CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T8CorrWeight, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T9CorrWeight, 1024, 0, 2048, 103, 0.002)

// CorrHist update values
TUNE_PARAM(pawnCorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(nonPawnCorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T0CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T1CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T2CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T3CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T4CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T5CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T6CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T7CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T8CorrUpdate, 1024, 0, 2048, 103, 0.002)
TUNE_PARAM(T9CorrUpdate, 1024, 0, 2048, 103, 0.002)