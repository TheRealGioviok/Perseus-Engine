...
TUNE_PARAM(lmrNoTTBeta, 1024, 1, 2048, 103, 0.002) // The best index is the index of the best move in the move list. It is used to reduce the search depth if the best move is found later.
