...
struct Position{
    ...
    /** 
     * @brief The Position::generateNonPawnHashKey function generates the hash key of the non pawn structure from scratch.
     * @note This function is called by the constructors. Otherwise the hash gets incrementally updated.
     */
    HashKey generateNonPawnHashKey(const bool side);

    /**
     * @brief The Position::generateMinorHashKey function generates the hash key of minor structure from scratch.
     * @note This function is called by the constructors. Otherwise the hash gets incrementally updated.
     */
    HashKey generateMinorHashKey();

    /** 
     * @brief The Position::generateMinorHashKey function generates the hash key of the major structure from scratch.
     * @note This function is called by the constructors. Otherwise the hash gets incrementally updated.
     */
