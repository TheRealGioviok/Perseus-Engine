...
inline void Position::addQuiet(MoveList *ml, ScoredMove move, Square source, Square target, Move killer1, Move killer2, Move counterMove, const S16 *ply1contHist, const S16 *ply2contHist, const S16 *ply4contHist, const S16 *ply6contHist) {
    ...
    ml->moves[ml->count++] = ((
        ...
        + (S64)(ply6contHist ? ply6contHist[indexPieceTo(movePiece(move), target)] : 0)
        + QUIETSCORE
    ) << 32) | move;
}
...
void Position::generateMoves(MoveList& moveList, SStack* ss) {
    ...
    const S16 *ply6contHist = (ss - 6)->move ? (ss - 6)->contHistEntry : nullptr;
    ...
    while (knights) {
        ...
        while (quiets) {
            ...
            bool isCheck = (knightCheckers & squareBB(to)) > 0;
            addQuiet(&moveList, encodeMove(from, to, N + 6 * side, NOPIECE, NOPIECE, false, false, false, isCheck), from, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    ...
    while (bishops) {
        ...
        while (quiets) {
            Square to = popLsb(quiets);
            bool isCheck = (bishopCheckers & squareBB(to)) > 0;
            addQuiet(&moveList, encodeMove(from, to, B + 6 * side, NOPIECE, NOPIECE, false, false, false, isCheck), from, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    ...
    while (rooks) {
        ...
        while (quiets) {
            Square to = popLsb(quiets);
            bool isCheck = (rookCheckers & squareBB(to)) > 0;
            addQuiet(&moveList, encodeMove(from, to, R + 6 * side, NOPIECE, NOPIECE, false, false, false, isCheck), from, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    ...
    while (queens) {
        ...
        while (quiets) {
            Square to = popLsb(quiets);
            bool isCheck = (queenCheckers & squareBB(to)) > 0;
            addQuiet(&moveList, encodeMove(from, to, Q + 6 * side, NOPIECE, NOPIECE, false, false, false, isCheck), from, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    ...
    if (side == WHITE) {
        ...
        while (pawnPushes) {
            ...
            if (to <= h8) {
                ...
                addQuiet(&moveList, encodeMove(to + 8, to, P, NOPIECE, NOPIECE, false, false, false, (pawnCheckers & squareBB(to)) > 0), to + 8, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
        ...
        while (pawnDoublePushes) {
            ...
            addQuiet(&moveList, encodeMove(to + 16, to, P, NOPIECE, NOPIECE, true, false, false, (pawnCheckers & squareBB(to)) > 0), to + 16, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    else {
        BitBoard pawnPushes = ourPawns << 8;
    ...
    while (kMoves) {
        ...
        addQuiet(&moveList, encodeMove(king, to, K + 6 * side, NOPIECE, NOPIECE, false, false, false, false), king, to, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
    }
    // We will generate the castling moves
    if (side == WHITE) {
        if (castle & CastleRights::WK && !(occupancy & wKCastleMask)) {
            addQuiet(&moveList, encodeMove(e1, g1, K, NOPIECE, NOPIECE, false, false, true, false), e1, g1, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
        if (castle & CastleRights::WQ && !(occupancy & wQCastleMask)) {
            addQuiet(&moveList, encodeMove(e1, c1, K, NOPIECE, NOPIECE, false, false, true, false), e1, c1, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
    else {
        if (castle & CastleRights::BK && !(occupancy & bKCastleMask)) {
            addQuiet(&moveList, encodeMove(e8, g8, k, NOPIECE, NOPIECE, false, false, true, false), e8, g8, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
        if (castle & CastleRights::BQ && !(occupancy & bQCastleMask)) {
            addQuiet(&moveList, encodeMove(e8, c8, k, NOPIECE, NOPIECE, false, false, true, false), e8, c8, killer1, killer2, counterMove, ply1contHist, ply2contHist, ply4contHist, ply6contHist);
        }
    }
}
