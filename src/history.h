...
// history table
extern S16 historyTable[2][NUM_SQUARES * NUM_SQUARES];

// capture history table
extern S16 captureHistoryTable[NUM_PIECES * NUM_SQUARES][NUM_PIECES / 2]; // The color of the captured piece is always the opposite of the color of the moving piece
...
// Correction History
extern S16 pawnsCorrHist[2][CORRHISTSIZE];
extern S16 nonPawnsCorrHist[2][2][CORRHISTSIZE];
extern S16 minorCorrHist[2][CORRHISTSIZE]; // stm - hash
...
static inline S16 stat_bonus(int depth) {
