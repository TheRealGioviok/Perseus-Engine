...
constexpr PScore ADVANCABLEPHALANX = S(8, 25);
constexpr PScore R_SUPPORTEDPHALANX = S(2, 10);
constexpr PScore R_ADVANCABLEPHALANX = S(1, 18);
constexpr PScore passedRankBonus[7] = {S(0, 0), S(-2, -36), S(-21, -17), S(-15, 31), S(22, 71), S(47, 164), S(142, 251), };
constexpr PScore PASSEDPATHBONUS = S(-3, 18);
constexpr PScore SUPPORTEDPASSER = S(28, -2);
constexpr PScore INNERSHELTER = S(4, -7);
constexpr PScore OUTERSHELTER = S(12, 4);
constexpr PScore BISHOPPAIR = S(19, 128);
constexpr PScore ROOKONOPENFILE = S(25, 2);
constexpr PScore ROOKONSEMIOPENFILE = S(18, 16);
constexpr PScore KNIGHTONEXTOUTPOST = S(23, 32);
constexpr PScore BISHOPONEXTOUTPOST = S(27, -2);
constexpr PScore KNIGHTONINTOUTPOST = S(18, 38);
constexpr PScore BISHOPONINTOUTPOST = S(30, -8);
constexpr PScore KNIGHTPROTECTOR = S(-8, 0);
constexpr PScore BISHOPPROTECTOR = S(-5, 0);
constexpr PScore BISHOPPAWNS = S(1, -4);
constexpr PScore THREATSAFEPAWN = S(50, 62);
constexpr PScore THREATPAWNPUSH = S(20, 35);
constexpr PScore PAWNHANGING = S(-4, -58);
constexpr PScore NONPAWNHANGING = S(-24, -35);
constexpr PScore KINGTHREAT = S(-2, 4);
constexpr PScore QUEENINFILTRATION = S(2, -3);
constexpr PScore RESTRICTEDSQUARES = S(4, 3);
constexpr PScore TEMPO = S(15, 23);

constexpr PScore PAWNATTACKINNERRING = S(-13, -218);
constexpr PScore KNIGHTATTACKINNERRING = S(-76, -29);
constexpr PScore BISHOPATTACKINNERRING = S(-95, 23);
constexpr PScore ROOKATTACKINNERRING = S(-106, 22);
constexpr PScore QUEENATTACKINNERRING = S(-74, -107);
constexpr PScore PAWNATTACKOUTERRING = S(-73, -81);
constexpr PScore KNIGHTATTACKOUTERRING = S(-83, 31);
constexpr PScore BISHOPATTACKOUTERRING = S(-70, 61);
constexpr PScore ROOKATTACKOUTERRING = S(-32, 4);
constexpr PScore QUEENATTACKOUTERRING = S(-59, 93);
constexpr PScore NOQUEENDANGER = S(794, -159);
constexpr PScore PINNEDSHELTERDANGER = S(-96, -20);

constexpr PScore FLANKATTACKS[2] = {S(-32, -48), S(-39, -47), };
constexpr PScore FLANKDEFENSES[2] = {S(37, 1), S(7, -6), };

constexpr PScore SAFECHECK[4] = {S(-280, -58), S(-73, 26), S(-210, 92), S(-207, -1), };
constexpr PScore ALLCHECKS[4] = {S(-75, 15), S(-31, 79), S(-70, 0), S(-8, 51), };
constexpr PScore SAFETYINNERSHELTER = S(48, 11);
constexpr PScore SAFETYOUTERSHELTER = S(14, -23);
constexpr PScore INNERWEAKNESS = S(-84, -14);
constexpr PScore OUTERWEAKNESS = S(-15, 9);
constexpr PScore KSTEMPO = S(-22, 30);

constexpr Score COMPLEXITYPASSERS = 217;
constexpr Score COMPLEXITYPAWNS = 969;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -358;
constexpr Score COMPLEXITYPAWNTENSION = -875;
constexpr Score COMPLEXITYOUTFLANKING = -25;
constexpr Score COMPLEXITYINFILTRATION = -723;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 9904;
constexpr Score COMPLEXITYPAWNENDING = 12938;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3502;
constexpr Score COMPLEXITYBIAS = -19332;
