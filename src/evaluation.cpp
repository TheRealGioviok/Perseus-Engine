...
const PScore passedRankBonus[7] = {
    S(0,0), S(-16,23), S(-36,35), S(-28,76), S(9,108), S(32,196), S(127,253)
};

const PScore SAFECHECK[4] = {
    S(150,-25), S(34,0), S(92,19), S(90,10)
};

const PScore ALLCHECKS[4] = {
    S(36,4), S(11,23), S(36,1), S(7,15)
};
...
constexpr PScore PAWNATTACKINNERRING = S(13, -35);
constexpr PScore KNIGHTATTACKINNERRING = S(46, -5);
constexpr PScore BISHOPATTACKINNERRING = S(41, 4);
constexpr PScore ROOKATTACKINNERRING = S(43, 10);
constexpr PScore QUEENATTACKINNERRING = S(32, -24);
constexpr PScore PAWNATTACKOUTERRING = S(32, -11);
constexpr PScore KNIGHTATTACKOUTERRING = S(39, 4);
constexpr PScore BISHOPATTACKOUTERRING = S(46, 2);
constexpr PScore ROOKATTACKOUTERRING = S(24, -3);
constexpr PScore QUEENATTACKOUTERRING = S(40, 16);
constexpr PScore NOQUEENDANGER = S(-355, -869);
constexpr PScore PINNEDSHELTERDANGER = S(54, -2);
constexpr PScore SAFETYINNERSHELTER = S(-29, -59);
constexpr PScore SAFETYOUTERSHELTER = S(-24, -63);
constexpr PScore INNERWEAKNESS = S(48, -15);
constexpr PScore OUTERWEAKNESS = S(7, 2);

constexpr Score COMPLEXITYPASSERS = 223;
constexpr Score COMPLEXITYPAWNS = 896;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -352;
constexpr Score COMPLEXITYPAWNTENSION = -819;
constexpr Score COMPLEXITYOUTFLANKING = -18;
constexpr Score COMPLEXITYINFILTRATION = -746;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 9644;
constexpr Score COMPLEXITYPAWNENDING = 12854;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3894;
constexpr Score COMPLEXITYBIAS = -18523;
