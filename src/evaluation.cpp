...
constexpr PScore DOUBLEISOLATEDPEN = S(16, 49);
...
constexpr PScore passedRankBonus[7] = {S(0, 0), S(10, -81), S(-11, -52), S(-6, 3), S(25, 55), S(48, 151), S(140, 245), };
constexpr PScore PASSEDPATHBONUS = S(-5, 23);
constexpr PScore SUPPORTEDPASSER = S(28, 0);
constexpr PScore INNERSHELTER = S(-1, -30);
constexpr PScore OUTERSHELTER = S(7, -18);
...
constexpr PScore PAWNATTACKINNERRING = S(18, -41);
constexpr PScore KNIGHTATTACKINNERRING = S(56, -5);
constexpr PScore BISHOPATTACKINNERRING = S(56, 6);
constexpr PScore ROOKATTACKINNERRING = S(54, 14);
constexpr PScore QUEENATTACKINNERRING = S(43, -32);
constexpr PScore PAWNATTACKOUTERRING = S(42, -9);
constexpr PScore KNIGHTATTACKOUTERRING = S(49, 5);
constexpr PScore BISHOPATTACKOUTERRING = S(57, 4);
constexpr PScore ROOKATTACKOUTERRING = S(30, -4);
constexpr PScore QUEENATTACKOUTERRING = S(49, 20);
constexpr PScore NOQUEENDANGER = S(-470, -1094);
constexpr PScore PINNEDSHELTERDANGER = S(71, -11);
constexpr PScore SAFECHECK[4] = {S(195, -27), S(46, 0), S(119, 29), S(119, 13), };
constexpr PScore ALLCHECKS[4] = {S(46, 6), S(18, 29), S(44, 0), S(9, 16), };
constexpr PScore SAFETYINNERSHELTER = S(-37, -77);
constexpr PScore SAFETYOUTERSHELTER = S(-31, -80);
constexpr PScore INNERWEAKNESS = S(65, -22);
constexpr PScore OUTERWEAKNESS = S(8, 4);
constexpr PScore KSTEMPO = S(18, 6);

constexpr Score COMPLEXITYPASSERS = 218;
constexpr Score COMPLEXITYPAWNS = 959;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -364;
constexpr Score COMPLEXITYPAWNTENSION = -844;
constexpr Score COMPLEXITYOUTFLANKING = -36;
constexpr Score COMPLEXITYINFILTRATION = -864;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 10105;
constexpr Score COMPLEXITYPAWNENDING = 13048;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3448;
constexpr Score COMPLEXITYBIAS = -19571;
