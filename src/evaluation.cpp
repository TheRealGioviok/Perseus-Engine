...
constexpr PScore INNERSHELTER = S(11, -33);
constexpr PScore OUTERSHELTER = S(13, -17);
...
constexpr PScore KINGTHREAT = S(-1, 4);
constexpr PScore QUEENINFILTRATION = S(1, -16);
constexpr PScore RESTRICTEDSQUARES = S(5, 3);
constexpr PScore TEMPO = S(20, 29);

constexpr PScore PAWNATTACKINNERRING = S(32, -50);
constexpr PScore KNIGHTATTACKINNERRING = S(57, -13);
constexpr PScore BISHOPATTACKINNERRING = S(55, -4);
constexpr PScore ROOKATTACKINNERRING = S(56, 2);
constexpr PScore QUEENATTACKINNERRING = S(48, -28);
constexpr PScore PAWNATTACKOUTERRING = S(33, -13);
constexpr PScore KNIGHTATTACKOUTERRING = S(40, 3);
constexpr PScore BISHOPATTACKOUTERRING = S(44, 3);
constexpr PScore ROOKATTACKOUTERRING = S(25, -4);
constexpr PScore QUEENATTACKOUTERRING = S(39, 19);
constexpr PScore NOQUEENDANGER = S(-294, -913);
constexpr PScore PINNEDSHELTERDANGER = S(51, 0);
constexpr PScore SAFETYINNERSHELTER = S(-26, -59);
constexpr PScore SAFETYOUTERSHELTER = S(-22, -60);
constexpr PScore KINGINNERMOB = S(-8, 0);

constexpr Score COMPLEXITYPASSERS = 216;
constexpr Score COMPLEXITYPAWNS = 900;
...
constexpr Score COMPLEXITYINFILTRATION = -738;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 9624;
constexpr Score COMPLEXITYPAWNENDING = 12798;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3897;
constexpr Score COMPLEXITYBIAS = -18473;

//constexpr Score KSAMG = -2;
constexpr double KSCALEMG = 840.2962646484375;
constexpr double KSBMG = 2.078787088394165;
constexpr double KSCMG = -2.9214863777160645;
// constexpr Score KSAEG = -71;
constexpr double KSCALEEG = 1138.7742919921875;
constexpr double KSBEG = 2.564945936203003;
constexpr double KSCEG = 2.716344118118286;
