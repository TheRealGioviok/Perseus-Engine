...
Score pestoEval(Position *pos){
    ...
    PScore score = pos->psqtScores[indexColorKingsKingside(WHITE, wkhside == bkhside, wkhside)] + pos->psqtScores[indexColorKingsKingside(BLACK, wkhside == bkhside, bkhside)];
