...
constexpr PScore passedRankBonus[7] = {S(0, 0), S(10, -82), S(-11, -52), S(-7, 2), S(24, 55), S(48, 153), S(107, 195), };
constexpr PScore PASSEDPATHBONUS = S(-5, 23);
constexpr PScore SUPPORTEDPASSER = S(28, 1);
constexpr PScore INNERSHELTER = S(-1, -32);
constexpr PScore OUTERSHELTER = S(6, -20);
...
constexpr PScore THREATSAFEPAWN = S(49, 62);
...
constexpr PScore QUEENINFILTRATION = S(2, -7);
constexpr PScore RESTRICTEDSQUARES = S(4, 4);
constexpr PScore TEMPO = S(14, 24);

constexpr PScore PAWNATTACKINNERRING = S(30, -87);
constexpr PScore KNIGHTATTACKINNERRING = S(83, -11);
constexpr PScore BISHOPATTACKINNERRING = S(85, 15);
constexpr PScore ROOKATTACKINNERRING = S(81, 30);
constexpr PScore QUEENATTACKINNERRING = S(63, -69);
constexpr PScore PAWNATTACKOUTERRING = S(64, -24);
constexpr PScore KNIGHTATTACKOUTERRING = S(73, 9);
constexpr PScore BISHOPATTACKOUTERRING = S(84, 5);
constexpr PScore ROOKATTACKOUTERRING = S(47, -9);
constexpr PScore QUEENATTACKOUTERRING = S(72, 49);
constexpr PScore NOQUEENDANGER = S(-720, -1845);
constexpr PScore PINNEDSHELTERDANGER = S(108, -31);
constexpr PScore SAFECHECK[4] = {S(296, -62), S(66, 14), S(188, 65), S(185, 31), };
constexpr PScore ALLCHECKS[4] = {S(68, 12), S(18, 69), S(67, 5), S(13, 32), };
constexpr PScore SAFETYINNERSHELTER = S(-57, -164);
constexpr PScore SAFETYOUTERSHELTER = S(-42, -185);
constexpr PScore INNERWEAKNESS = S(103, -48);
constexpr PScore OUTERWEAKNESS = S(13, 6);
constexpr PScore KSTEMPO = S(29, 15);

constexpr Score COMPLEXITYPASSERS = 206;
constexpr Score COMPLEXITYPAWNS = 974;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -358;
constexpr Score COMPLEXITYPAWNTENSION = -899;
constexpr Score COMPLEXITYOUTFLANKING = -65;
constexpr Score COMPLEXITYINFILTRATION = -866;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 10351;
constexpr Score COMPLEXITYPAWNENDING = 13182;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3335;
constexpr Score COMPLEXITYBIAS = -20235;
