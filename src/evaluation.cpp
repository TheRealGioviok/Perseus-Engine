...
constexpr Score BACKWARDPENMG = 6;
...
constexpr Score passedRankBonusMg [7] = {0, -10, -34, -26, 12, 16, 81, };
constexpr Score PASSEDPATHBONUSMG = -1;
constexpr Score SUPPORTEDPASSERMG = 29;
constexpr Score INNERSHELTERMG = 24;
...
constexpr Score KNIGHTONEXTOUTPOSTMG = 29;
constexpr Score BISHOPONEXTOUTPOSTMG = 33;
constexpr Score KNIGHTONINTOUTPOSTMG = 26;
constexpr Score BISHOPONINTOUTPOSTMG = 40;
constexpr Score BISHOPPAWNSMG = 1;
constexpr Score THREATSAFEPAWNMG = 62;
constexpr Score THREATPAWNPUSHMG = 24;
constexpr Score TEMPOMG = 23;
// (EG)
constexpr Score DOUBLEISOLATEDPENEG = 52;
constexpr Score ISOLATEDPENEG = 20;
constexpr Score BACKWARDPENEG = 19;
...
constexpr Score passedRankBonusEg [7] = {0, -75, -51, -1, 38, 127, 168, };
...
constexpr Score BISHOPPAIREG = 108;
constexpr Score ROOKONOPENFILEEG = -5;
constexpr Score ROOKONSEMIOPENFILEEG = 22;
constexpr Score KNIGHTONEXTOUTPOSTEG = 29;
constexpr Score BISHOPONEXTOUTPOSTEG = 0;
constexpr Score KNIGHTONINTOUTPOSTEG = 33;
constexpr Score BISHOPONINTOUTPOSTEG = -8;
constexpr Score BISHOPPAWNSEG = -3;
constexpr Score THREATSAFEPAWNEG = 59;
constexpr Score THREATPAWNPUSHEG = 25;
constexpr Score TEMPOEG = 19;


constexpr Score PAWNATTACKINNERRING = 16;
constexpr Score KNIGHTATTACKINNERRING = 8;
constexpr Score BISHOPATTACKINNERRING = 24;
constexpr Score ROOKATTACKINNERRING = 29;
constexpr Score QUEENATTACKINNERRING = 19;

constexpr Score PAWNATTACKOUTERRING = 18;
constexpr Score KNIGHTATTACKOUTERRING = 35;
constexpr Score BISHOPATTACKOUTERRING = 22;
constexpr Score ROOKATTACKOUTERRING = 14;
constexpr Score QUEENATTACKOUTERRING = 23;

constexpr Score NOQUEENDANGER = -144;
constexpr Score PINNEDSHELTERDANGER = 23;
