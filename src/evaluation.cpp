...
constexpr PScore passedRankBonus[7] = {S(0, 0), S(10, -82), S(-12, -53), S(-7, 2), S(25, 54), S(47, 151), S(141, 245), };
constexpr PScore PASSEDPATHBONUS = S(-4, 23);
constexpr PScore SUPPORTEDPASSER = S(29, 0);
constexpr PScore INNERSHELTER = S(-2, -31);
...
constexpr PScore PAWNATTACKINNERRING = S(23, -83);
constexpr PScore KNIGHTATTACKINNERRING = S(87, -8);
constexpr PScore BISHOPATTACKINNERRING = S(86, 16);
constexpr PScore ROOKATTACKINNERRING = S(87, 30);
constexpr PScore QUEENATTACKINNERRING = S(61, -68);
constexpr PScore PAWNATTACKOUTERRING = S(55, -27);
constexpr PScore KNIGHTATTACKOUTERRING = S(70, 4);
constexpr PScore BISHOPATTACKOUTERRING = S(81, -2);
constexpr PScore ROOKATTACKOUTERRING = S(38, -12);
constexpr PScore QUEENATTACKOUTERRING = S(67, 41);
constexpr PScore INNERDOUBLEATTACKS = S(32, -28);
constexpr PScore OUTERDOUBLEATTACKS = S(56, 34);
constexpr PScore NOQUEENDANGER = S(-747, -2272);
constexpr PScore PINNEDSHELTERDANGER = S(99, -30);
constexpr PScore SAFECHECK[4] = {S(278, -64), S(55, 2), S(169, 57), S(171, 41), };
constexpr PScore ALLCHECKS[4] = {S(77, 20), S(28, 68), S(78, 4), S(19, 27), };
constexpr PScore SAFETYINNERSHELTER = S(-55, -159);
constexpr PScore SAFETYOUTERSHELTER = S(-49, -163);
constexpr PScore INNERWEAKNESS = S(99, -41);
constexpr PScore OUTERWEAKNESS = S(16, 5);
constexpr PScore KSTEMPO = S(29, 18);

constexpr Score COMPLEXITYPASSERS = 208;
constexpr Score COMPLEXITYPAWNS = 969;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -339;
constexpr Score COMPLEXITYPAWNTENSION = -878;
constexpr Score COMPLEXITYOUTFLANKING = -33;
constexpr Score COMPLEXITYINFILTRATION = -891;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 10126;
constexpr Score COMPLEXITYPAWNENDING = 13125;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3443;
constexpr Score COMPLEXITYBIAS = -19669;
