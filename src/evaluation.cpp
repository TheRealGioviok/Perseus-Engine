...
constexpr PScore ISOLATEDPEN = S(-17, -20);
constexpr PScore BACKWARDPEN = S(-7, 7);
constexpr PScore DOUBLEDPEN = S(-20, -23);
constexpr PScore SUPPORTEDPHALANX = S(1, 9);
constexpr PScore ADVANCABLEPHALANX = S(7, 9);
constexpr PScore R_SUPPORTEDPHALANX = S(3, 1);
constexpr PScore R_ADVANCABLEPHALANX = S(4, 0);
constexpr PScore passedRankBonus[2][7] = {
    {S(0, 0), S(9, -68), S(-5, -46), S(-2, 9), S(20, 65), S(43, 158), S(114, 230)}, 
    {S(0, 0), S(0, 0), S(8, -60), S(10, -5), S(55, 66), S(155, 186), S(390, 259)}
};
constexpr PScore PASSEDPATHBONUS = S(-5, 23);
constexpr PScore candidateRankBonus[2][7] = {
    {S(0, 0), S(-37, 8), S(-25, 24), S(-9, 60), S(5, 128), S(35, 101), S(0, 0)}, 
    {S(0, 0), S(0, 0), S(-7, 35), S(2, 68), S(46, 143), S(124, 172), S(0, 0)}
};
constexpr PScore INNERSHELTER = S(1, 2);
constexpr PScore OUTERSHELTER = S(13, 11);
constexpr PScore BISHOPPAIR = S(18, 115);
constexpr PScore ROOKONOPENFILE = S(19, 10);
constexpr PScore ROOKONSEMIOPENFILE = S(23, 10);
constexpr PScore KNIGHTONEXTOUTPOST = S(29, 41);
constexpr PScore BISHOPONEXTOUTPOST = S(38, 4);
constexpr PScore KNIGHTONINTOUTPOST = S(23, 45);
constexpr PScore BISHOPONINTOUTPOST = S(35, 0);
constexpr PScore KNIGHTPROTECTOR = S(-6, -3);
constexpr PScore BISHOPPROTECTOR = S(-4, -3);
constexpr PScore BISHOPPAWNS = S(1, -4);
constexpr PScore THREATSAFEPAWN = S(44, -41);
constexpr PScore THREATPAWNPUSH = S(21, 42);
constexpr PScore PAWNHANGING = S(2, -53);
constexpr PScore NONPAWNHANGING = S(-9, -39);
constexpr PScore PAWNTHREAT[2][5] = {
    {S(12, -69), S(31, 77), S(27, 119), S(29, 42), S(9, 28)}, 
    {S(5, -28), S(10, 124), S(12, 165), S(24, 93), S(16, 86)}
};
constexpr PScore KNIGHTTHREAT[2][5] = {
    {S(7, 21), S(-12, -37), S(26, 19), S(58, -12), S(39, 13)}, 
    {S(-7, 9), S(-13, 11), S(26, 72), S(52, 58), S(42, 43)}
};
constexpr PScore BISHOPTHREAT[2][5] = {
    {S(13, 20), S(33, 26), S(-2, -44), S(58, -7), S(54, 24)}, 
    {S(3, 13), S(33, 72), S(2, 4), S(51, 65), S(49, 71)}
};
constexpr PScore ROOKTHREAT[2][5] = {
    {S(2, 19), S(12, 48), S(22, 34), S(-18, -20), S(55, -3)}, 
    {S(-11, 6), S(2, 24), S(6, 14), S(-9, 22), S(41, 45)}
};
constexpr PScore QUEENTHREAT[2][5] = {
    {S(12, -3), S(26, -4), S(26, 15), S(-4, -21), S(-19, -31)}, 
    {S(-1, 7), S(6, -2), S(3, 2), S(-2, 7), S(-14, -24)}
};
constexpr PScore KINGTHREAT = S(-4, -5);
constexpr PScore QUEENINFILTRATION = S(2, 8);
constexpr PScore INVASIONSQUARES = S(6, 6);
constexpr PScore RESTRICTEDSQUARES = S(4, 4);
constexpr PScore TEMPO = S(19, 32);

constexpr PScore PAWNATTACKINNERRING = S(20, -221);
constexpr PScore KNIGHTATTACKINNERRING = S(67, -6);
constexpr PScore BISHOPATTACKINNERRING = S(105, -29);
constexpr PScore ROOKATTACKINNERRING = S(103, 100);
constexpr PScore QUEENATTACKINNERRING = S(46, -164);
constexpr PScore PAWNATTACKOUTERRING = S(56, 50);
constexpr PScore KNIGHTATTACKOUTERRING = S(89, -19);
constexpr PScore BISHOPATTACKOUTERRING = S(90, -35);
constexpr PScore ROOKATTACKOUTERRING = S(34, 7);
constexpr PScore QUEENATTACKOUTERRING = S(70, 264);
constexpr PScore NOQUEENDANGER = S(-727, 688);
constexpr PScore PINNEDSHELTERDANGER = S(102, -377);
constexpr PScore FLANKATTACKS[2] = {S(21, -56), S(28, 23), };
constexpr PScore FLANKDEFENSES[2] = {S(-32, 75), S(-4, 66), };
constexpr PScore SAFECHECK[4] = {S(288, -91), S(94, -21), S(226, 171), S(216, -149), };
constexpr PScore ALLCHECKS[4] = {S(71, -14), S(27, 305), S(60, 54), S(21, 161), };
constexpr PScore SAFETYINNERSHELTER = S(-54, 409);
constexpr PScore SAFETYOUTERSHELTER = S(-9, 908);
constexpr PScore INNERWEAKNESS = S(97, -153);
constexpr PScore OUTERWEAKNESS = S(18, -28);
constexpr PScore KSTEMPO = S(32, -33);

constexpr Score COMPLEXITYPASSERS = 446;
constexpr Score COMPLEXITYPAWNS = 1116;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -405;
constexpr Score COMPLEXITYPAWNTENSION = -849;
constexpr Score COMPLEXITYOUTFLANKING = -17;
constexpr Score COMPLEXITYINFILTRATION = -677;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 10192;
constexpr Score COMPLEXITYPAWNENDING = 13491;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3304;
constexpr Score COMPLEXITYBIAS = -21269;
...
static inline void getMobilityFeat(const BitBoard (&bb)[12], BitBoard occCheck, const BitBoard pinned, const BitBoard mobilityArea, BitBoard &attackedByUs, BitBoard &ourMultiAttacks, BitBoard &ptAttacks, S8 *features, const Square kingSquare, const BitBoard kingRing, const BitBoard kingOuter, S32 &innerAttacks, S32 &outerAttacks, S32 &kingDist) {
    ...
    while (pieces) {
        ...
        if constexpr (pt == N || pt == n) {
            ...
            features[popcount(mobMoves)] += us == WHITE ? 1 : -1;
            // Add pinned term correction if necessary
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                features[9+popcount(mobMoves)] += us == WHITE ? 1 : -1;
            }
            // Knight defender
            ...
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                features[14+popcount(mobMoves)] += us == WHITE ? 1 : -1;
            }
            // Bishop defender
            kingDist += chebyshevDistance[kingSquare][sq] * (us == WHITE ? 1 : -1);
        }
            ...
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                features[15+popcount(mobMoves)] += us == WHITE ? 1 : -1;
            }
        }
            ...
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                features[28+popcount(mobMoves)] += us == WHITE ? 1 : -1;
            }
        }
...
static inline void mobility(const BitBoard *bb, BitBoard occCheck, const BitBoard pinned, const BitBoard mobilityArea, PScore &score, BitBoard &attackedByUs, BitBoard &ourMultiAttacks, BitBoard &ptAttacks, const Square kingSquare, const BitBoard kingRing, const BitBoard kingOuter, PScore &innerAttacks, PScore &outerAttacks){
    ...
    while (pieces) {
        ...
        if constexpr (pt == N) {
            ...
            mobMoves = moves & mobilityArea;
            // Add the mobility score
            score += knightMob[popcount(mobMoves)] + KNIGHTPROTECTOR * chebyshevDistance[kingSquare][sq];
            // Add pinned term correction if necessary
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                score += pinnedKnightMob[popcount(mobMoves)];
            }
            ...
            mobMoves = moves & mobilityArea;
            // Add the mobility score
            score += bishopMob[popcount(mobMoves)] + BISHOPPROTECTOR * chebyshevDistance[kingSquare][sq];
            // Add pinned term correction if necessary
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                score += pinnedBishopMob[popcount(mobMoves)];
            }
            ...
            mobMoves = moves & mobilityArea;
            // Add the mobility score
            score += rookMob[popcount(mobMoves)];
            // Add pinned term correction if necessary
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                score += pinnedRookMob[popcount(mobMoves)];
            }
            ...
            moves = getQueenAttack(sq, occCheck);
            mobMoves = moves & mobilityArea;
            score += queenMob[popcount(mobMoves)];
            // Add pinned term correction if necessary
            if (squareBB(sq) & pinned) {
                mobMoves &= alignedSquares[kingSquare][sq];
                moves &= alignedSquares[kingSquare][sq];
                score += pinnedQueenMob[popcount(mobMoves)];
            }
...
std::vector<Score> getCurrentEvalWeights(){
   ...
   // Add the passed pawn bonus list
    ...
    for (U8 mobcount = 0; mobcount < 6; mobcount++){
        weights.push_back(pinnedKnightMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 14; mobcount++){
        weights.push_back(bishopMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 6; mobcount++){
        weights.push_back(pinnedBishopMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 15; mobcount++){
        weights.push_back(rookMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 6; mobcount++){
        weights.push_back(pinnedRookMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 28; mobcount++){
        weights.push_back(queenMob[mobcount].eg());
    }
    for (U8 mobcount = 0; mobcount < 6; mobcount++){
        weights.push_back(pinnedQueenMob[mobcount].eg());
    }
    // Add the pawn evaluation weights
