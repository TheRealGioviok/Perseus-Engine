...
constexpr PScore passedRankBonus[7] = {S(0, 0), S(10, -89), S(-9, -60), S(-3, -6), S(28, 47), S(51, 149), S(150, 241), };
constexpr PScore PASSEDPATHBONUS = S(-4, 25);
constexpr PScore SUPPORTEDPASSER = S(28, 2);
constexpr PScore INNERSHELTER = S(3, -8);
constexpr PScore OUTERSHELTER = S(9, 4);
constexpr PScore BISHOPPAIR = S(19, 129);
constexpr PScore ROOKONOPENFILE = S(22, 13);
constexpr PScore ROOKONSEMIOPENFILE = S(19, 10);
constexpr PScore KNIGHTONEXTOUTPOST = S(25, 38);
constexpr PScore BISHOPONEXTOUTPOST = S(29, 0);
constexpr PScore KNIGHTONINTOUTPOST = S(24, 41);
constexpr PScore BISHOPONINTOUTPOST = S(34, -7);
constexpr PScore KNIGHTPROTECTOR = S(-6, -1);
constexpr PScore BISHOPPROTECTOR = S(-4, 0);
constexpr PScore BISHOPPAWNS = S(1, -4);
constexpr PScore THREATSAFEPAWN = S(48, 63);
constexpr PScore THREATPAWNPUSH = S(20, 37);
constexpr PScore PAWNHANGING = S(-4, -65);
constexpr PScore NONPAWNHANGING = S(-25, -38);
constexpr PScore KINGTHREAT = S(-2, -1);
constexpr PScore QUEENINFILTRATION = S(-2, -4);
constexpr PScore RESTRICTEDSQUARES = S(4, 4);
constexpr PScore TEMPO = S(11, 31);

constexpr PScore PAWNATTACKINNERRING = S(-55, 100);
constexpr PScore KNIGHTATTACKINNERRING = S(98, 43);
constexpr PScore BISHOPATTACKINNERRING = S(98, -10);
constexpr PScore ROOKATTACKINNERRING = S(105, -37);
constexpr PScore QUEENATTACKINNERRING = S(106, -95);
constexpr PScore PAWNATTACKOUTERRING = S(72, -53);
constexpr PScore KNIGHTATTACKOUTERRING = S(62, 223);
constexpr PScore BISHOPATTACKOUTERRING = S(83, 90);
constexpr PScore ROOKATTACKOUTERRING = S(32, 49);
constexpr PScore QUEENATTACKOUTERRING = S(65, 10);
constexpr PScore NOQUEENDANGER = S(-609, -8066);
constexpr PScore PINNEDSHELTERDANGER = S(126, -31);
constexpr PScore SAFECHECK[4] = {S(291, 507), S(139, -199), S(249, -4), S(213, 15), };
constexpr PScore ALLCHECKS[4] = {S(71, 144), S(29, 107), S(90, -53), S(13, 47), };
constexpr PScore SAFETYINNERSHELTER = S(-58, 30);
constexpr PScore SAFETYOUTERSHELTER = S(-47, -30);
constexpr PScore INNERWEAKNESS = S(74, 50);
constexpr PScore OUTERWEAKNESS = S(14, 18);
constexpr PScore KSTEMPO = S(54, 0);

constexpr Score COMPLEXITYPASSERS = 259;
constexpr Score COMPLEXITYPAWNS = 958;
constexpr Score COMPLEXITYBLOCKEDPAIRS = -323;
constexpr Score COMPLEXITYPAWNTENSION = -879;
constexpr Score COMPLEXITYOUTFLANKING = -75;
constexpr Score COMPLEXITYINFILTRATION = -1013;
constexpr Score COMPLEXITYPAWNBOTHFLANKS = 10606;
constexpr Score COMPLEXITYPAWNENDING = 12536;
constexpr Score COMPLEXITYALMOSTUNWINNABLE = -3428;
constexpr Score COMPLEXITYBIAS = -20202;
