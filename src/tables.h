...
// def poly(x):
//     return .0439 * (x**2) + 1.2768*x - 3.1295
// a = [0.1206125, 0.0707375, 0.2469125, 0.29425, 0.1721125, 0.1441875, 0.3389, 0.2084625, 0.1362625, 0.243275, -1.3693875, 0.22215]
// print([round(sigmoid(poly(k/128))*512) for k in np.linspace(-255,768,64)])
const Score kingSafety[] = {
	  2,   2,   3,   3,   4,   4,   5,   6 ,
      7,   8,   9,  10,  12,  14,  16,  19 ,
     22,  26,  31,  36,  42,  49,  57,  66 ,
     77,  89, 102, 118, 135, 153, 173, 195 ,
    218, 241, 265, 289, 313, 335, 357, 377 ,
    396, 412, 427, 440, 452, 462, 470, 478 ,
    484, 489, 493, 497, 499, 502, 504, 505 ,
    507, 508, 509, 509, 510, 510, 511, 511 ,
